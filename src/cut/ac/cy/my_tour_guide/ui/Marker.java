...
import cut.ac.cy.my_tour_guide.objects.PaintableObject;
import cut.ac.cy.my_tour_guide.objects.PaintablePoint;
...
public class Marker implements Comparable<Marker> {
    ...
    /**
     * Get the resources name of the marker
     */
    ...
    private synchronized void updateRadar() {
        ...
        //Log.e("Radar is on Radar: ", String.valueOf(isOnRadar));
    }
